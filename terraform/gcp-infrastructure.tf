...
resource "google_service_account_iam_member" "rancher_wif_binding" {
  ...
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.rancher_pool.name}/subject/system:serviceaccount:${var.namespace}:${var.service_account}"
}
